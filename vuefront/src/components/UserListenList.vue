<template>
  <div class="user-listen-list">
    <table>
      ...
      <tr>
        <td><input class="form-control" v-model="listen.title" type="text"></td>
        <td><input class="form-control" size="1" v-model="listen.album" type="text"></td>
        <td><input class="form-control" size="1" v-model="listen.artist" type="text"></td>
        <td></td>
        <td><button @click="addListen()">Add</button></td>
      </tr>
      <tr v-for="song in songs" :key="song.Listen_ID">
        ...
        <td><button @click="deleteListen(song.Listen_ID)">Delete</button></td>
      </tr>
    </table>
  </div>
</template>
